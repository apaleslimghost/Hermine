...
const data: Record<string, Stop> = {
	...
	'Rond-point des pistes': { to: ['Roc (bottom)', 'Castor & Pollux', 'Pionniers', 'Lac Blanc'] },
	...
	'Cascades (top)': { to: ['Ardoises', 'Dalles (top)', '2 combes (top)', 'Cascades'] },
	'Lac 2': { to: ['Moutiere (bottom)', 'Plateau (lift)'] },
	'Circuit de Glace': { to: ['Plein Sud', 'Cairn (bottom)', '2 Lacs'] },
	'Chalet du Thorens': { to: ['Combe de thorens', 'Moraine (lift)', 'Portette (lift)'] },
	...
	'Moutiere (bottom)': { type: 'blue', to: ['Grand Fond', 'Lagopede (bottom)'] },
	...
	'Grand Fond': { type: 'funitel', to: ['Niverolle (top)', 'Bd rosael (top)', 'Variente'] },
	...
	Peclet: { type: 'funitel', to: ['Beranger (top)', 'Tete ronde (top)', 'Lac blanc (top)'] },
	'Lac blanc (top)': { type: 'red', to: ['Les vires', 'Lac blanc (bottom)'] },
	'Lac blanc (bottom)': { type: 'red', to: ['Beranger (bottom)', 'Bd Lauzes (bottom)'] },
	'Beranger (top)': { type: 'red', to: ['Beranger (bottom)', 'Bd Lauzes (bottom)'] },
	'Les vires': { type: 'red', to: ['Bd Lauzes (top)', 'Croissant', 'Adrien Theaux'] },
	'Lac Blanc': { type: 'telesiege', to: ['Bd Lauzes (top)', 'Croissant', 'Adrien Theaux'] },
	...
	'Dalles (bottom)': { type: 'blue', to: ['Bleuets (top)', 'Combe de thorens (bottom)'] },
	'2 combes (bottom)': { type: 'green', to: ['Combe de thorens'] },
	'Bleuets (top)': { type: 'blue', to: ['Bleuets (bottom)'] },
	'Tete ronde (top)': { type: 'blue', to: ['Tete ronde (bottom)', 'Christine'] },
