export const elements = [
	...
	{ data: { id: 'fuma', label: 'La Fuma', type: 'black', source: 'maronne-top', target: 'farcis-fuma-junction', turnDistance: '100%'}},
	{ data: { id: 'farcis-top', label: 'Farcis', type: 'blue', source: 'rhodos-farcis-col-junction', target: 'farcis-fuma-junction',}},
	{ data: { id: 'farcis-bottom', label: 'Farcis', type: 'blue', source: 'farcis-fuma-junction', target: 'maronne-village', turnDistance: '0%', direction: 'leftward'}},
	{ data: { id: 'eterlous', label: 'Eterlous', type: 'blue', source: 'auris-express-top', target: 'fontfroide-picnic', turnDistance: '100%', direction: 'vertical'}},
	...
	{ data: { id: 'bergerie', label: 'Bergerie', type: 'black', source: 'signal-de-lhomme', target: 'lys-gua-junction', direction: 'rightward', turnDistance: '100%'}},
	{ data: { id: 'gua-top', label: 'Gua', type: 'blue', source: 'lys-gua-junction', target: 'gua-sarenne-junction', direction: 'vertical'}},
	{ data: { id: 'gua-middle-2', label: 'Gua', type: 'blue', source: 'gua-sarenne-junction', target: 'chalvets-bottom', turnDistance: '100%'}},
...
export const constraints = {
	alignmentConstraint: {
		horizontal: [
			['chalvets-bottom', 'lombards-bottom', 'alpauris-bottom']
		],
		vertical: [
